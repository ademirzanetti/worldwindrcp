...
/**
 * A thread to load remote real time satellite data sets from
 * the NAVY Labs & NOAA GOES. These datasets are images siting on a HTTP
...
public class LayerLoaderJob extends Job 
{
	...
	public IStatus run(IProgressMonitor monitor) 
	{
		try {
			...
			display.syncExec(new Runnable() {
				public void run() {
//					treeViewer.addBuiltInTreeObject(parent
//							, children
//							, true
//							, false);
