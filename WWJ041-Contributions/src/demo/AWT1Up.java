...
//                ((TimeLoopGroundOverlay)anim).play();
                ...
                final BasicDragger dragger = new BasicDragger(wwd);
        ...
        private PlacemarkLayer buildPlacemarkLayer() 
        {
        	...
        	l.addDefaultIcon(position.toString(), position, position.toString());
...
//            addFilledPolylineBox(layer, Sector.fromDegrees(1, 1.9, 1, 1.9), 10e3, 200e3);
        ...
        private void addFilledPolylineBox(RenderableLayer layer, Sector s, double bottomAlt, double topAlt) 
        {
            ...
            //filledPolyline.setFollowTerrain(true);
            filledPolyline.setFilled(false);
            ...
            filledPolyline = new Polyline(posList);
            //filledPolyline.setFollowGreatCircles(false);
            filledPolyline.setFilled(true);
