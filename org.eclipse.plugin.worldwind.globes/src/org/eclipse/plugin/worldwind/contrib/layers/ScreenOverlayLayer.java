...
public class ScreenOverlayLayer extends AbstractLayer
{
    ...
    public ScreenOverlayLayer(String name, String iconFilePath, String position) 
    {
    	...
    	boolean iconFound = LayerUtils.getWWFileStore().findFile(iconFilePath, false) != null;
    	...
    	try {
        	if ( ! iconFound ) {
        		...
        		setIconFilePath(LayerUtils.getWWFileStore().newFile(iconFilePath));
        	}
    ...
    private void initializeTexture(DrawContext dc) throws IOException
    {
        ...
        try
        {
        	...
        	URL url = LayerUtils.getWWFileStore().findFile(getName(), false);
        	...
        	if ( iconTexture != null) {
        		...
        		final File f = LayerUtils.getWWFileStore().newFile(getName() + ".png");
